...
(function () {
  ...
  const STROKE = {
    ...
    // Guide — open book
    book:
      '<path d="M4.2 5.1h6.4a2.4 2.4 0 0 1 2.4 2.4v11.2a1.7 1.7 0 0 0-1.7-1.7H4.2Z"/>' +
      '<path d="M19.8 5.1h-6.4a2.4 2.4 0 0 0-2.4 2.4v11.2a1.7 1.7 0 0 1 1.7-1.7h7.1Z"/>' +
      '<path d="M12 7.6v10.9"/>',
    ...
    // Prep — list
    list:
      '<path d="M9.2 7h10.2M9.2 12h10.2M9.2 17h10.2"/>' +
      '<path d="M5.1 7h.01M5.1 12h.01M5.1 17h.01"/>',
